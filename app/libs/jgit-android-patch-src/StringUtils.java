...
public final class StringUtils {
	...
	// Android runtime compat: String.strip only exists on Android API 33+
	// (Java 11+). Manual trim works everywhere.
	/**
	 * Strip leading and trailing whitespace; compatible replacement for
	 * {@code String.strip()} on older runtimes (Android API < 33).
	 *
	 * @param s
	 *            string to strip
	 ...
	 * @since 6.10
	 */
	public static String stripCompat(String s) {
		int start = 0;
		int len = s.length();
